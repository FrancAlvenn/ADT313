            ...
            <form>
                <div className='casts-details'>
                  ...
                  <div className="field">
                    Artist Name
                    <input type="text" 
                    value={selectedCast.name ? selectedCast.name : ''}
                    name='name'
                    onChange={handleOnChange}
                    ref={nameRef}
                    />
                    {debounceState && isFieldsDirty && selectedCast.name == '' && (<span className='errors'>This field is required</span>)}
                  </div>
                  <div className="field">
                    Character Name
                    <input type="text"
                    value={selectedCast.characterName ? selectedCast.characterName : ''}
                    name='characterName'
                    onChange={handleOnChange}
                    ref={characterNameRef}
                    />
                    {debounceState && isFieldsDirty && selectedCast.characterName == '' && (<span className='errors'>This field is required</span>)}
                  </div>
                  <div className="field">
                    Profile Image
                    <input type="text"
                    value={selectedCast.url ? selectedCast.url : ''}
                    name='url'
                    onChange={handleOnChange}
                    ref={urlRef}
                    />
                    {debounceState && isFieldsDirty && selectedCast.url == '' && (<span className='errors'>This field is required</span>)}
                  </div>
